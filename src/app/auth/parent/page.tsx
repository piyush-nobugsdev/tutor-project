...
export default function ParentAuthPage() {
  ...
  const handleSignIn = async (provider: 'google' | 'github') => {
    ...
    // Store role in localStorage BEFORE OAuth
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900">Sign up as Parent</h1>
          <p className="mt-2 text-gray-600">Find qualified tutors for your child</p>
        </div>
        ...
        <div className="rounded-lg bg-white p-8 shadow-md">
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="flex w-full items-center justify-center gap-3 rounded-lg bg-gray-900 px-4 py-3 font-medium text-white transition-colors hover:bg-gray-800 disabled:opacity-50"
            >
